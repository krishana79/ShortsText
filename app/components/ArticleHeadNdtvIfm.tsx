...
const ArticleHeadNdtvIfm = () => {
  return (
    <>
      <div className="NstCrd_img">
        <div className="img-gr img-gr_a">
          <iframe
            className="img-gr_ytb"
            src="https://www.youtube.com/embed/MN8p-Vrn6G0?autoplay=1&controls=0&mute=1&loop=1&playlist=MN8p-Vrn6G0"
            frameBorder={0}
        ...
        <div className="NstCrd_lgo">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 79.4 15.8">
            <defs>
              <style
...
export default ArticleHeadNdtvIfm;
